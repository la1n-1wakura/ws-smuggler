...
├── docs/                  # дополнительные документы; сейчас пустой каталог
...
- **Запись трафика** — сохранение raw TX/RX, hex, PCAP и events JSONL.
...
Пакет пока не опубликован в PyPI. Ниже приведена команда для будущей публикации;
до этого используйте установку из исходников или Git-репозитория.
